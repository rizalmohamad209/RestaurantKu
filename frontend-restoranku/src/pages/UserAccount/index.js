...
import { LayoutOne, Responsive, Text, Card } from 'upkit'
...
const menus = [
    ...
    {
        label: 'Alamat', icon: <IconWrapper><FaAddressBook /></IconWrapper>,
        url: '/address'
    },
    {
        label: 'Pesanan', icon: <IconWrapper><FaFileInvoice />
        </IconWrapper>, url: '/pesanan'
    },
    {
